...
public class Signup {
    ...
    Picker pickerregion;
    Picker pickerville;
    int idpays,idreg,idville;

    public Signup(Resources theme, Form parentForm) {
        ...
        connectButton.addActionListener((evt) -> {
            ...
            Message message = Message.creator(new PhoneNumber("+216"+phoneTf.getText() ),
                    ...
                    verifMessage).create();
            //  Profile p = new Profile(nomTf.getText(), prenomTf.getText(), passTf.getText(), mailTf.getText(), 1);
           Profile p = new Profile(nomTf.getText(), prenomTf.getText(),  mailTf.getText(),loginTf.getText(),passTf.getText(),phoneTf.getText(),idpays,idreg,idville,1,verifCode);
